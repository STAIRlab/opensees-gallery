...
foreach shellType {ShellMITC4 ASDShellQ4 ShellDKGQ ShellNLDKGQ} {
	...
	fixY $length  0 1 0 1 0 1 -tol 1.0e-2
        ...
        recorder Element  -xml  out/${shellType}_force_out.xml  -ele  1  force
        ...
        recorder Element  -xml  out/${shellType}_force_gp1_out.xml  -ele  1  material  1  force
        ...
        recorder Element  -xml  out/${shellType}_stress_gp1_fib0_out.xml  -ele  1  material  1  fiber 1 stress
