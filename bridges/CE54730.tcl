...
set ft [expr 12.*$in];              # define derived units
...
# nodal coordinates:  node tag X Y Z
...
# bent columns
element nonlinearBeamColumn 1 1 4 $numIntgrPts $SecTag $ColTransfTag;
element nonlinearBeamColumn 2 2 6 $numIntgrPts $SecTag $ColTransfTag;
# cap beam
element elasticBeamColumn 3 3 4 $ABeam $Ec $Gc $JBeam $IyBeam $IzBeam $BeamTransfTagL;
element elasticBeamColumn 4 4 5 $ABeam $Ec $Gc $JBeam $IyBeam $IzBeam $BeamTransfTagR;
element elasticBeamColumn 5 5 6 $ABeam $Ec $Gc $JBeam $IyBeam $IzBeam $BeamTransfTagL;
element elasticBeamColumn 6 6 7 $ABeam $Ec $Gc $JBeam $IyBeam $IzBeam $BeamTransfTagR;
# deck
element elasticBeamColumn  7  8  9 $ADeck $Ec $Gc $JDeck $IyDeck $IzDeck $DeckTransfTag;
element elasticBeamColumn  8  9 10 $ADeck $Ec $Gc $JDeck $IyDeck $IzDeck $DeckTransfTag;
element elasticBeamColumn  9 10 11 $ADeck $Ec $Gc $JDeck $IyDeck $IzDeck $DeckTransfTag;
element elasticBeamColumn 10 11  5 $ADeck $Ec $Gc $JDeck $IyDeck $IzDeck $DeckTransfTag;
element elasticBeamColumn 11  5 12 $ADeck $Ec $Gc $JDeck $IyDeck $IzDeck $DeckTransfTag;
element elasticBeamColumn 12 12 13 $ADeck $Ec $Gc $JDeck $IyDeck $IzDeck $DeckTransfTag;
element elasticBeamColumn 13 13 14 $ADeck $Ec $Gc $JDeck $IyDeck $IzDeck $DeckTransfTag;
