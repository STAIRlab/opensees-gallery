...
variable maxNumIterDynamic 10000;                # Convergence Test: maximum number of iterations that will be performed before "failure to converge" is returned
...
# for improved-convergence procedure:
	variable maxNumIterConvergeDynamic 20000;	
