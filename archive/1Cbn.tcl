 #########################################################################################################################
 # Test example for Specimen 1Cb tested by Nisreen Balh (2010) 					  			             #
...
set Atruss 10000.0; #rigid
 ...
 uniaxialMaterial CFSSSWP $matID $hight $width $fuf $fyf $tf $Af $fus $fys $ts $np $ds $Vs $screw_Spacing $dt $opening_Area $opening_Length  
 ...
 set peakpts [list  0.0015    0.0015    0.0015    0.0015    0.0015    0.0015    0.0022    0.0016    0.0016    0.0016    0.0016    0.0016    0.0016	0.0029    0.0022    0.0022    0.0022    0.0022    0.0022    0.0022    0.0058    0.0044    0.0044    0.0044    0.0087    0.0067	0.0067    0.0067    0.0117    0.0087    0.0087    0.0204    0.0154    0.0154    0.0291    0.0219    0.0219]
 set increments 10
 set nodeTag 2
 set dofTag 1
