...
puts "Verification of Elastic SDOF systems (Chopra)"
...
#   input args: K                -  stiffness
#               periodStruct     -  structure period (used to compute mass)
#               dampRatio (zeta) -  damping ratio
...
proc buildLinearAnalysis {integratorCommand} {
    ...
    #integrator GeneralizedAlpha 1 1 0.5 [expr 1.0/6.0]
    system ProfileSPD
    analysis Transient
}
...
puts [format {%20s%15.5f%10s%15.5f} OpenSees: $uOpenSees Exact: $uExact]
...
# print table header
puts [format "%15s%15s%15s%15s" Period Damping OpenSees Exact]
...
foreach {period dampRatio} {0.5 0.02 1.0 0.02 2.0 0.02 2.0 0.0 2.0 0.02 2.0 0.05} {
    ...
    puts [format "%15.2f%15.2f%15.2f%15.2f" $period $dampRatio $maxU $uExact]
