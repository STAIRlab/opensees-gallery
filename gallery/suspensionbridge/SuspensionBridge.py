...
def SuspensionBridge():
    ...
    # Create nodes.
    # The file nodes.json maps node names to coordinates.
    # Read this and iterate to add the nodes to the model
    with open("nodes.json", "r") as f:
        for name, coord in json.load(f).items():
            ops.node(name, *coord)

    # Set the mass at each node.
