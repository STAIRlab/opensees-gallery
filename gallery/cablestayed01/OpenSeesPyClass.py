...
class OpenSeesPyClass():
    ...
    def __init__(self,caseNumber,waveNumber):
        ...
        self.dbPath = "output/resultsDB_"+str(self.caseNumber)+str("_")+str(self.waveNumber)+".db"
    ...
    def ele_nonlinearBeamColumn(self,nonlinearEleList,integrationPoint=5,tipsString=''):
        ...
        for each in nonlinearEleList:
            ...
            ops.element('forceBeamColumn', EleTag, EleNodeI, EleNodeJ, integrationPoint,
    ...
    def analysis_modal(self,numModes=10,tipsString=''):
        ...
        for i2 in range(10):
            print(str(i2 + 1) + ' th period is: ' + str(savePeridList[i2]) + ' second', file=sys.stderr)
        print(tipsString + ' constructing finish...', file=sys.stderr)
    ...
    def earthquake_excite(self,dampRatio,Tstart,Tend,waveLenthList,dtList,dirList,motionList,recordList=None):
        ...
        while (tCurrent < tFinal):
            ...
            if (ok == 0):
                ...
                print("The ground motion ",self.waveNumber," failed!", file=sys.stderr)
                break
