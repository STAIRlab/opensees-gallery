...
# 	TYPE: THREE-DIRECTIONAL DYNAMIC ANALYSIS, VARIABLE FRICTION COEFFICIENTS
...
set GMFilez 	TCU065-V.ATH;	# Input ground motion
set nSteps 		14000; 			# Number of steps to analyze
set GMFac		9.81;			# GM factor = 9.81 m/s^2
...
# Creating nodes
node 1 0. 0. 0.;
node 2 0. 0. 1. -mass [expr $W/$g] [expr $W/$g] [expr $W/$g] 1. 1. 10.;
#---------------------------------------------
