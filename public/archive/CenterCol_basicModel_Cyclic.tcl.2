...
puts "HI"
set dataDir Analysis_LimitStateMaterial(Load)-Cyclic
file mkdir $dataDir
################################
...
recorder Node -file $dataDir/node4Disp.out -time -node 4 -dof 1 disp
...
if {$loading == "push"} {
    ...
    set path {1.2557524028480316  1.2557524028480316  3.0608252487525078  1.5641001656305775  1.1015791633965932 -1.8313432524451514}
