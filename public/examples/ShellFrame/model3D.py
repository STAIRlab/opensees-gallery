...
#   model = opensees.openseespy.Model(ndm=ndm, ndf=ndf)
    ops.wipe()
    ...
    # Define the geometric transformation with the appropriate geoTag
        model.geomTransf('Linear', geoTag, *vecxz)
    model.element('elasticBeamColumn', nsc_eletag, slab_nodetag, nsc_nodetag,axial_area_nsc, E_nsc, G_nsc, Jxx_nsc, Iy_nsc, Iz_nsc, geoTag)
