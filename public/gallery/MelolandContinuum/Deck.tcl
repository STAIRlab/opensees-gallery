...
# There is no user-defined parameter in the files but it is recommended to go through all 
# the command lines before running it.
...
# Create input file for GiD software
...
for { set i 1 } { $i <= [ expr $numXele_D+1] } { incr i 1 } {
    for { set j 1 } { $j <= [ expr $numYele_D+1] } { incr j 1 } { 
      ...
      } elseif { $i > [expr $Dzone1/$xSize_D1+$Dzone2/$xSize_D2 +1] } {  
